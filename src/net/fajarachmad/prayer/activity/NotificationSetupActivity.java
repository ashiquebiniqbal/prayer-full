...
public class NotificationSetupActivity extends PreferenceActivity implements AppConstant {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title = getResources().getString(R.string.notification_setup_title, prayName);
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        Toolbar bar = (Toolbar) LayoutInflater.from(this).inflate(R.layout.common_settings_toolbar, root, false);
        bar.setTitle(title);
